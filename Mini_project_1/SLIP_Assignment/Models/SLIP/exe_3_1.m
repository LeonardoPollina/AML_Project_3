...
grid on
box on
a = plot(y_in, y_out, 'b','LineWidth',2)
ax = gca;
ax.FontSize = 20;
% All periodic solutions are on this line:
b = line(y_in, y_in, 'color', 'r','LineWidth',2)
%axis equal
%axis tight
xlabel('y before stride','FontWeight','bold','FontSize',24,...
    'FontName','Times New Roman')
ylabel('y after stride','FontWeight','bold','FontSize',24,...
    'FontName','Times New Roman')
...
c = line([y_in(13),y_in(13)],[0.8,y_out(13)],'color','b')
line([y_in(13),y_out(13)],[y_out(13),y_out(13)],'color','b')
line([y_out(13),y_out(13)],[y_out(13),y_out(27)],'color','b')
line([y_out(13),y_out(27)],[y_out(27),y_out(27)],'color','b')
line([y_out(27),y_out(27)],[y_out(27),y_out(35)],'color','b')
line([y_out(27),y_out(35)],[y_out(35),y_out(35)],'color','b')
...
xticklabels({'0.8','1.0','1.2','1.4','1.6', '1.8'})
yticks([0.8 1.0 1.2 1.4 1.6 1.8])
yticklabels({'0.8','1.0','1.2','1.4','1.6', '1.8'})
ylim([0.8 1.8])
 
%set(gca,'FontSize',20)
h = legend([a b c], 'Real input-output function','Periodicity Line (y_{in}=y_{out})', 'Sample trajectory')
set(h,'FontSize',16)
...
subplot(2,1,2);
plot(y_in(1:end-1),diff(y_out)./diff(y_in),'color','b','LineWidth', 2)
ax = gca;
ax.FontSize = 20;
hold on
grid on
...
xlabel('y before stride','FontWeight','bold','FontSize',24,...
        'FontName','Times New Roman')
ylabel('EigenValues','FontWeight','bold','FontSize',24,...
        'FontName','Times New Roman')
...
h=legend('Eigenvalues of y return map', 'Stability border: Eigenvalue = 1')
set(h,'FontSize',16)
